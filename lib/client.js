      ...
      if (connection === "close") {
              ...
              await conn.sendMessage(conn.user.id, {
                ...
                contextInfo: {
                  ...
                  externalAdReply: {
                    ...
                    body: "",
                    thumbnailUrl: "https://files.catbox.moe/owbcxr.jpg",
                    sourceUrl:
        ...
        function externalPreview(profileImage, options = {}) {
          return {
            ...
            thumbnailUrl: profileImage || "https://files.catbox.moe/owbcxr.jpg",
            sourceUrl:
              options.sourceUrl ||
              "https://whatsapp.com/channel/0029VbAnkJQ5q08d0hilkS2J",
            mediaType: 1,
        ...
        conn.ev.on("group-participants.update", async (update) => {
          ...
          for (const user of participants) {
            ...
            try {
              ...
              profileImage = "https://files.catbox.moe/owbcxr.jpg";
            }
